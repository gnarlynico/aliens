...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instance for game stats and scoreboard
        ...
        # Play button
        self.play_button = Button(self, "KILL EM")
    ...
    def _check_bullet_alien_collisions(self):
        # Check for bullet hits and eliminate bullet and alien
    ...
    def _update_aliens(self):
        """Check if fleet reached edge, update all ship positions"""
    ...
    def _create_fleet(self):
        ...
        # Make an alien and find how many in a row
        # Spacing between aliens is one aliens width
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond if alien has reached the edge"""
